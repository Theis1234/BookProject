...
export class BookListComponent implements OnInit{
  ...
  onSearch(searchData: { title?: string, genre?: string, authorName?: string }): void {
  this.bookService.searchBooks(searchData.title, searchData.genre, searchData.authorName).subscribe({
